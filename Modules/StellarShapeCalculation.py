'''
These are slightly adjusted versions of pynbody.analysis.halo.halo_shape
The original script is meant for dark matter, and has been tweaked here
to operate on star particles.
The first function operates as the original, measuring shapes in thin
ellipsoids.
The second function uses all the particles interior to the current radius,
rather than those within the shell.
'''
